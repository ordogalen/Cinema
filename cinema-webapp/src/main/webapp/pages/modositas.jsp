...
<jsp:include page="/Modositas_Controller"/>
    <div id="chairArea">
    ...
    <div class="form-popup" id="foglalas-container">
        <form action="${pageContext.request.contextPath}/Modositas_Controller" method="post" class ="form-container">
            ...
            <input type="text" id="vetites_id" name="vetites_id" value="${requestScope.vetites_id}" hidden readonly="readonly"/>
            <input type="text" id="jegy_id" name="jegy_id" value="${requestScope.jegy_id}" hidden readonly="readonly"/>
            <input type="text" id="modositottHelyek" value="${requestScope.aktualisSzekek}" hidden required name="helyek" readonly="readonly"><br>
            <input id = "foglal" class="btn" type="submit" value="Modositas">
